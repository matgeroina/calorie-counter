        ...
        <section className="card">
            ...
            <div className="row">
                <label className="label">
                    Date<input type="date" value={date} className="input" onChange={(e) => setDate(e.target.value)} />
                </label>
                <label className="label">
                    Daily Goal (kcal)
                    <input type="number" className="input" min="0" value={goal} onChange={(e) => setGoal(Number(e.target.value))}/>
                </label>
            </div>
            <div className="stats">
                <div className="stat">
